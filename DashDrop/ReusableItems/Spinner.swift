...
struct Spinner: View {
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: .red, lineWidth: lineWidth)

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: .red, lineWidth: lineWidth)
