...
//                    OrderDetailSheet(order: selectedOrder, viewModel: viewModel)
//                }
//            }
//        }
...
struct OrderMap: UIViewRepresentable {
    ...
    func configureMap(mapView: MKMapView, with coordinator: Coordinator) {
        ...
        directions.calculate { response, error in
            ...
            mapView.setVisibleMapRect(rect, edgePadding: UIEdgeInsets(top: 44, left: 32, bottom: 500, right: 32), animated: true)
        }
    }
